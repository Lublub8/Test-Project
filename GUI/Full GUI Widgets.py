...
MainTab=Notebook(root,width=500)
MainTab.pack()

#Frames ******************
NewFrame = Frame(MainTab)
MainTab.add(NewFrame,text="GUI TKK Template ")

SecondFrame = Frame(MainTab)
MainTab.add(SecondFrame,text="Test ")
